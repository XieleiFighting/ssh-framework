 ...
 * <p/>
 * 1、当调用如下方法时，加缓存
 * {@link com.hades.ssh.service.sys.UserAuthService#findRoles}
 * {@link com.hades.ssh.service.sys.UserAuthService#findStringRoles}
 * {@link com.hades.ssh.service.sys.UserAuthService#findStringPermissions}
 * <p/>
 * 2、授权（Auth）
 * 当增删改授权时，
 * 如果是用户相关的，只删用户的即可，
...
public class UserAuthCacheAspect extends BaseCacheAspect {
     ...
     * 其他的全部清理
     */
    @Pointcut(value = "target(com.hades.ssh.service.sys.AuthService)")
     ...
     * 当删除权限时，清缓存
     */
    @Pointcut(value = "target(com.hades.ssh.service.sys.PermissionService)")
     ...
     * 当修改角色show/role/resourcePermissions关系时，清缓存
     */
    @Pointcut(value = "target(com.hades.ssh.service.sys.RoleService)")
     ...
     * 当删除/修改show字段时，清缓存
     */
    @Pointcut(value = "target(com.hades.ssh.service.sys.OrganizationService)")
     ...
     * 当删除/修改show字段时，清缓存
     */
    @Pointcut(value = "target(com.hades.ssh.service.sys.JobService)")
     ...
     * 当删除组时，清缓存
     */
    @Pointcut(value = "target(com.hades.ssh.service.sys.GroupService)")
     ...
     * 其他情况，清所有
     */
    @Pointcut(value = "target(com.hades.ssh.service.sys.GroupRelationService)")
     ...
     * 修改时，如果组织机构/工作职务变了，仅需清自己的缓存
     */
    @Pointcut(value = "target(com.hades.ssh.service.sys.UserService)")
    ...
    @Pointcut(value = "target(com.hades.ssh.service.sys.UserAuthService)")
