package com.hades.ssh.common.utils.html;
...
import com.hades.ssh.common.utils.html.jsoup.SSHCleaner;
import com.hades.ssh.common.utils.html.jsoup.SSHWhitelist;
...
public class HtmlUtils {
    ...
    public static String removeUnSafeTag(String html) {
        SSHWhitelist whitelist = new SSHWhitelist();
        ...
        SSHCleaner cleaner = new SSHCleaner(whitelist);
